...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.1.1.5. [Редактирование даных о шаблоне](#P3.1.1.5)  
...
##### <a name="P3.1.1.1.5">3.1.1.5. Редактирование даных о шаблоне</a>
**Описание.** Авторизированный пользователь имеет возможность редактировать данные о загруженном им шаблоне.

|Функция|Требование|
|:---|:---|
|Редактирование даных о шаблоне|Приложение должно предоставить авторизированному пользователю возможность отредактировать данные о загруженном им шаблоне.|
