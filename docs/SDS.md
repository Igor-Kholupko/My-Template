...
&nbsp;&nbsp;&nbsp;&nbsp;1.2.5. [Скачать шаблон](#124-Скачать-шаблон)  
...
**Основной поток.**  
 ...
 4. Пользователь вводит имя пользователя и пароль.  
...
2. Приложение перенаправляет пользователя на страницу, где открыт документ.  
3. Вариант использования завершается.  
...
3. Пользователь указывает необходимые данные (теги, название, описание, загружаемый файл).  
...
**Описание.** Вариант использования "Опубликовать загружаемый шаблон" позволяет пользователю опубликовать шаблон, чтобы другие пользователи имели возможность просматривать и скачивать шаблон.  
...
**Основной поток.**  
1. Вариант использования начинается, когда был завершился вариант использования "Загрузить шаблон".  
...
3. Пользователь корректирует необходимые данные.  
